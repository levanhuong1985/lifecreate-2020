...
<?php include('inc/header.php'); ?>
	...
	<section class="main-page">
		<div class="main-ttl">
			<h2 class="fadeup"><span class="en poppins">CONTACT</span><span class="jp">お問い合わせ</span></h2>
		</div>
		<figure><img src="<?php echo home_url('imgs/contact/img_main.jpg'); ?>" alt="CONTACT お問い合わせ" class="imgfull"></figure>
	</section><!-- .main-page -->
...
/*zipcode*/       
  ...
  //$("span.error").remove();
	...
	var chk_agree = $("input.agree:checked").length;
	if(chk_agree == 0)
		{
			$(":input[class='agree']").addClass("error_input");
